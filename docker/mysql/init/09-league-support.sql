...
-- 2. Insert default league FIRST (before creating foreign keys)
...
ON DUPLICATE KEY UPDATE `name` = 'Liga Główna';

-- 3. Create user_league join table (many-to-many relationship)
...
-- 4. Add league_id to prediction table
...
-- 5. Add league_id to ranking table
...
-- 6. Add league_id to ranking_history table
...
-- 7. Add league_id to user_points table
...
-- 8. Add league_id to chat_message table
