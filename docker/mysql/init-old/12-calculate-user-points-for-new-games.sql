-- Calculate and insert user_points for games 79-87 (9 new finished games)
...
WHERE g.id IN (79, 80, 81, 82, 83, 84, 85, 86, 87)
...
UPDATE prediction
SET calculated = 1
WHERE game_id IN (79, 80, 81, 82, 83, 84, 85, 86, 87);
